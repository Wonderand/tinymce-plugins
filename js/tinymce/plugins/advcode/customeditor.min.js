...
!function() {
    ...
    tinymce.Resource.add("tinymce.plugins.advcode.customeditor", ((r,s)=>new Promise((i=>{
        i((async t=>{
            ...
            const {setValue: o, getValue: a, copyCode: u, formatCode: h, setDarkMode: l, changeFontSize: c, setFontSize: g, destroy: d} = i(r, s, "", s.currentAdvStatus)
              , m = {
                getValue: a,
                setValue: o,
                destroy: d
            ...
            n(v).bind((t=>e.from(t.plugins.advcode))).map((r=>(r[y] || (r[y] = (()=>{
                const r = (t=>{
                    const r = (t=>{
                        let e = t;
                        return {
